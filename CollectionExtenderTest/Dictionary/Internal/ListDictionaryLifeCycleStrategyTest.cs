...
{
    public class ListDictionaryLifeCycleStrategyTest : DictionaryLifeCycleStrategyTest
    {
        public ListDictionaryLifeCycleStrategyTest()
        {
            _DictionaryLifeCycleStrategy = new ListDictionaryLifeCycleStrategy<string, string>(2);
        }

        [Fact]
        public void Add_OnOneElementDictionary_Returns_ListDictionary_With_CorrectInformation()
        {
            ...
            _OneElement.Should().BeOfType<ListDictionary<string, string>>();
        }

        [Fact]
        public void Remove_OnDictionaryWithThresholdElements_Returns_ListDictionary_OnSuccess()
        {
            ...
            _ThreeElements.Should().BeOfType<ListDictionary<string, string>>();
        }
