...
{
    public class MutableListDictionaryTest
    {
        ...
        public MutableListDictionaryTest()
        {
            _DictionaryTwoElements = new MutableListDictionary<string,string>
                (new Dictionary<string, string>(){  { "Key0", "Value0" }, { "Key1", "Value1" }}, 3);
            _DictionaryThreeElements = new MutableListDictionary<string, string>
        ...
        {
            var res = new MutableListDictionary<string, string>();
